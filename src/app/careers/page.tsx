    ...
    <>
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 60% 50%, #1e6fbf 0%, transparent 60%)",
          }}
        />
        ...
        <div className="max-w-4xl mx-auto">
          <FadeIn>
            <div className="mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-bold leading-tight" style={{ color: "#e2e8f0" }}>
                Open Positions
              </h2>
            </div>
          </FadeIn>
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      <span
                        className="px-3 py-1 rounded-full text-xs font-semibold"
                        style={{ background: "rgba(30,111,191,0.15)", color: "#bfdbfe" }}
                      >
                        {location}
                      </span>
                    </div>
